...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    public RestResponseVO sendRegisterEmail(String email) {
        ...
        try {
            ...
            String href = "http://127.0.0.1:8081/user/registerSubmitPage?email=" + email + "&token=" + token;
...
//            send email
            ...
            String href = "http://127.0.0.1:8081/user/forgetSubmitPage?email=" + email + "&token=" + token;
